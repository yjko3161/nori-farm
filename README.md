...
| | 게임 | 설명 |
|---|---|---|
| 🌀 | **미로 찾기** | 절차적으로 생성되는 무한 미로. 토끼(🐰)가 당근(🥕)을 찾아가요. 레벨 올라갈수록 미로가 커짐 |
| 🔍 | **틀린 그림 찾기** | 동물 농장 장면 3종(🚜빨간헛간 / 🥕텃밭 / 🦆연못). 매번 다른 차이 5개 |
| 🎯 | **두더지 잡기** | 20초 라운드. 두더지가 점점 빨리 튀어나옴 |
...
`<game>`: `maze` | `find` | `whack` | `memory` | `math` | `sound` | `snake`
